                ...
                <Row style={{ width: '100%' }}>
                    ...
                    <Col lg={3}>
                        ...
                        <Card.Body>
                            ...
                            <ListGroup variant="flush">
                                <ListGroup.Item>Name: {object.reporting_manager_name}</ListGroup.Item>
                                <ListGroup.Item>Phone Number: {object.manager_contact_number}</ListGroup.Item>
                                <ListGroup.Item>EmailID: {object.manager_email_id}</ListGroup.Item>
