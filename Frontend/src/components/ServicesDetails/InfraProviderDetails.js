            ...
            <Jumbotron fluid style={{backgroundColor:"white"}}>
                <Row style={{ width: '100%' }}>
                    ...
                    <Col lg={4}>
                        <Card style={{ width: '100%' }}>
                        <Card.Body>
                            <Card.Header as="h4">Infrastruture Details</Card.Header>
                            <ListGroup variant="flush">
                                <ListGroup.Item>{object.job.job_name}</ListGroup.Item>
                                ...
                                <ListGroup.Item>Facilities Available: {object.basic_facility==="All"?("Electricity,Water and Power Backup"):object.basic_facility}</ListGroup.Item>
                ...
                <Row style={{ width: '100%' }}>
                    ...
                    <Col sm={3}>
                        <Image src={this.props.location.state.link3} thumbnail style={{width:"100%",height:"90%"}}/>
                    </Col>
                    <Col sm={3}>
                        <Image src={this.props.location.state.link4} thumbnail style={{width:"100%",height:"90%"}}/>
                    </Col>
                </Row>
            </Jumbotron>
        );
