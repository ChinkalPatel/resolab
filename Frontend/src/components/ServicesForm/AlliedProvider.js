...
class AllProviderForm extends Component {
    constructor(props){
        super(props);
        this.state={
            org_name: "",
        ...
        if (this.state.file1 === null || this.state.file2 === null ) {
            ...
            this.setState({
                ...
                axios.get('https://api.resolabindia.com/core/get_presigned_url', {
                    params: {
                        "file_name": cookies.get("token") + "al1" + this.state.file1.name
                    }
                }).then((response1)=>{
                    ...
                    axios.post(response1.data.url, fd1, {
                        ...
                        axios.get('https://api.resolabindia.com/core/get_presigned_url', {
                            params: {
                                "file_name": cookies.get("token") + "al2" + this.state.file2.name
                            }
                        }).then((response2) => {
...
export default AllProviderForm;